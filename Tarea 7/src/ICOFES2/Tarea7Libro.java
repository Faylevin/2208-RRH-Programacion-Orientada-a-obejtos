...
public class Tarea7Libro {
    ...
    public void abrir() {
        System.out.println("El libro " + nombre + " está siendo abierto");
    }

    public void cerrar() {
        System.out.println("El libro "+ nombre +  " está siendo cerrado");
    }

    public void leer() {
        System.out.println("El libro de " + autor + " está siendo leído");
    }
